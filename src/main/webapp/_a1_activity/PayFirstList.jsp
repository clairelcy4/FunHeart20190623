...
<body>
	...
	<div class="section_content_activityList" style="min-height: 400px;">
		<div class="activityList">
			...
			<%-- 				${products_DPP.activityNo}<br> --%>
			<%-- 				[${products_DPP.activityBean.activityNo}]<b --%>
			<%-- 					class="welcome_text_bold">${products_DPP.activityBean.activityName}：${products_DPP.expenseTotal}</b> --%>
			<!-- 			</p> -->
			<p class="welcome_text">
