	...
	<div class="section_content_activityList" style="min-height: 400px;">
		<div class="activityList">
			...
			<form class="activityList_insert" id="form1" name="form1"
				method="post"
				action="ExpensesInsert.do?activityNo=${products_DPP.activityNo}"
				...
				<table
					...
					<tbody>
	             	...
	             	'DisplayPayFirst.do?activityNo=${products_DPP.activityNo}&expenseNo=${expenseBean.expenseNo}'">查看&#8594;</button>
								...
								<td>
									<form
										action="ExpensesDelete.do?activityNo=${products_DPP.activityNo}&expenseNo=${expenseBean.expenseNo}"
										method="post">
