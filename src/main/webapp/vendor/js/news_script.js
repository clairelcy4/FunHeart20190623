...
// Breaking News ticker by http://www.askwithloud.com
...
function arlinadesignTicker(t) {
  ...
  t.src = "http://" + $(".ticker-wrap").data("domain") + "/feeds/posts/summary?alt=json&callback=arlinadesignTicker", t.type = "text/javascript", document.getElementsByTagName("body")[0].appendChild(t)
});