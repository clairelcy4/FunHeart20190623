...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = { 
				@WebInitParam(name = "mustLogin1", value = "/_03_listOssans/*"), 
				@WebInitParam(name = "mustLogin2", value = "/_a3_buddyList/*"), 
				@WebInitParam(name = "mustLogin3", value = "/_a2_payBack/*"),
				@WebInitParam(name = "mustLogin4", value = "/_a1_activity/*")				
		})
public class LoginCheckingFilter implements Filter {
	...
	private boolean checkLogin(HttpServletRequest req) {
		...
		MemberBean loginTokenAdmin = (MemberBean) session.getAttribute("AdminLoginOK");
